 ...
 * @export
 * @interface PayToolsApiModelsPaymentGatewayAccountFullOutputModel
 */
export interface PayToolsApiModelsPaymentGatewayAccountFullOutputModel {
    /**
     * Name of account
     * @type {string}
     * @memberof PayToolsApiModelsPaymentGatewayAccountFullOutputModel
     */
    'name'?: string | null;
    /**
